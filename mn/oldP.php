...
<meta charset="utf-8">
<title>old patients detail</title>
</head>
<body>
<h1>List of all old patient</h1>

<?php
$db = pg_connect("host=127.0.01 port=5432 dbname=doctor user=postgres password=ravi");
$result = pg_query($db,"SELECT * FROM patient");
