...
<html>
<head> 
<title>check student detail by phone no</title>
      <style>
...
<form name="display" action="Sphone.php" method="POST" >
...
$result = pg_query($db, "SELECT * FROM student where phone = '$_POST[phone]'");
