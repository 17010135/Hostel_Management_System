...
<head> 
<meta charset="utf-8">
<title>check Student detail by Email</title>
      <style>
...
<form name="display" action="Semail.php" method="POST" >
...
$result = pg_query($db, "SELECT * FROM student where email = '$_POST[email]'");
